...
public class StripeController {
    ...
    private final com.davanddev.quizapp_api.repository.UserRepository userRepository;

    public StripeController(com.davanddev.quizapp_api.repository.UserRepository userRepository) {
